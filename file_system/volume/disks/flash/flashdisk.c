...
FS_STATUS_CODE flashdisk_write(RawVolume* self, void* sourceAddress, uint32_t destinationAddress, uint32_t size){
...
void* flashdisk_read(RawVolume* self, uint32_t sourceAddress, uint32_t size){
